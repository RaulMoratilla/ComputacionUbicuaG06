...
public class Registro {
    ...
    //ctor.
    public Registro(int p_codigoCiudadZonaCalle, int p_idZonaCalle, String p_nombreCalle, String p_tipo, String p_unidadMedida, Timestamp p_marcaTemporal, float p_valor) {
